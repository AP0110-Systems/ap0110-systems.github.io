...
Control is not a slogan; it needs concrete artifacts. The [agent-readable web standards](/wiki/agent-readable-web-standards/) — from [robots.txt](/docs/robots-txt/) to [llms.txt](/docs/llms-txt/) — are the first of them: operator-authored, advisory files by which a site governs its own machine readers. [Interpretable Context Methodology](/wiki/interpretable-context-methodology/) carries the same file-native, plain-text discipline into the workspace.
...
This page is a synthesis of open research anyone can read and check. Trace it back through the [source library](/docs/), follow how the ideas connect across the [wiki](/wiki/), or [read our story](/about/) to see why we are building it.
