...
const Footer = () => {
  ...
  const [showMoonImage, setShowMoonImage] = useState(false)
  ...
  useEffect(() => {
    ...
    const checkMoonImageVisibility = () => {
      const isLandscape = window.innerWidth > window.innerHeight
      const hasRoom = window.innerWidth >= 768 // md breakpoint
      setShowMoonImage(isLandscape && hasRoom)
    }

    const handleResize = () => {
      updateFooterVisibility()
      checkMoonImageVisibility()
    }
    ...
    window.addEventListener('orientationchange', checkMoonImageVisibility)

    return () => {
      window.removeEventListener('scroll', updateFooterVisibility)
      window.removeEventListener('resize', handleResize)
      window.removeEventListener('orientationchange', checkMoonImageVisibility)
    }
  }, [])
            ...
            <div className="max-w-6xl mx-auto w-full">
              ...
              <div id="footer-navigation" className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12" style={{ display: 'grid' }}>
                ...
                {/* <div>
                  ...
                  <ul className="space-y-2">
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">Documentation</a></li>
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">API Reference</a></li>
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">Community Forum</a></li>
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">GitHub</a></li>
                  </ul>
                </div> */}
                ...
                {/* <div>
                  ...
                  <ul className="space-y-2">
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">Help Center</a></li>
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">Contact Us</a></li>
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">Bug Reports</a></li>
                    <li><a href="#" className="text-gray-800 hover:text-black transition-colors">Feature Requests</a></li>
                  </ul>
                </div> */}
              ...
              {/* <div className="border-t border-gray-700 pt-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-4 text-black">Get Involved</h3>
              ...
              <div id="footer-copyright" className="border-t border-gray-700 pt-8 mt-8">
                <div className="flex flex-col md:flex-row justify-between items-center">
                  ...
                  <div id="footer-social-links" className="flex space-x-6 mt-4 md:mt-0">
                    ...
                    <a href="https://x.com/AP0110_net" target="_blank" rel="noopener noreferrer" className="w-6 h-6 text-gray-800 hover:text-black transition-colors">
                      <svg className="w-full h-full" viewBox="0 0 1200 1227">
                        <path d="M714.163 519.284L1160.89 0H1055.03L667.137 450.887L357.328 0H0L468.492 681.821L0 1226.37H105.866L515.491 750.218L842.672 1226.37H1200L714.137 519.284H714.163ZM569.165 687.828L521.697 619.934L144.011 79.6944H306.615L611.412 515.685L658.88 583.579L1055.08 1150.3H892.476L569.165 687.854V687.828Z" fill="currentColor"/>
                      </svg>
                    </a>
                    <a rel="me noopener noreferrer" href="https://mastodon.social/@AP0110" target="_blank" className="w-6 h-6 text-gray-800 hover:text-black transition-colors">
                    ...
                    <a href="https://bsky.app/profile/ap0110.net" target="_blank" rel="noopener noreferrer" className="w-6 h-6 text-gray-800 hover:text-black transition-colors">
                    ...
                    <a href="https://www.linkedin.com/company/ap0110" target="_blank" rel="noopener noreferrer" className="w-6 h-6 text-gray-800 hover:text-black transition-colors">
                    ...
                    <a href="https://www.instagram.com/ap0110_net" target="_blank" rel="noopener noreferrer" className="w-6 h-6 text-gray-800 hover:text-black transition-colors">
                    ...
                    <a href="https://medium.com/@AP0110" target="_blank" rel="noopener noreferrer" className="w-6 h-6 text-gray-800 hover:text-black transition-colors">
