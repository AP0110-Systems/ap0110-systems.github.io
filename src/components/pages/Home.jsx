...
export default function HomePage({ graph }) {
  return (
    <>
      ...
      <section className="px-4 py-12 md:py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-5 text-lg text-gray-700 leading-relaxed">
            ...
            <p className="text-black font-medium">It doesn&apos;t have to be this way.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 py-12 md:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-gray-700 mb-10 max-w-3xl">
            We call the alternative the <a href="/wiki/web4" className="text-ap-cyan hover:underline">Independent Internet</a> — Web 4.0. An internet people can run themselves, that keeps working when the grid goes down, and that answers to its community rather than a company. We build it in three ways.
          </p>
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl bg-white/70 backdrop-blur-sm border border-gray-200 p-6">
              <h3 className="text-xl font-bold text-black mb-2">Partner</h3>
        ...
        <div id="projects" className="max-w-6xl mx-auto grid sm:grid-cols-2 gap-6">
          ...
          <a href="/calcompute" className="group block rounded-2xl bg-light-blue text-white p-6 md:p-8 transition-transform hover:-translate-y-0.5">
            <div className="flex items-center gap-4 mb-3">
              <img src="/images/CalCompute.svg" alt="CalCompute" width={56} height={56} className="object-contain" style={{ maxHeight: '56px' }} />
          ...
          <a href="/unausa" className="group block rounded-2xl bg-un-blue text-white p-6 md:p-8 transition-transform hover:-translate-y-0.5">
            <div className="flex items-center gap-4 mb-3">
              <img src="/images/UNA-USA_white.svg" alt="UNA-USA" width={56} height={56} className="object-contain" />
          ...
          <a href="/children" className="group block sm:col-span-2 rounded-2xl bg-lii text-white p-6 md:p-8 transition-transform hover:-translate-y-0.5">
            <div className="flex items-center gap-4 mb-3">
              <img src="/images/lii-logo.png" alt="Life Impact International" width={56} height={56} className="object-contain rounded-xl" />
