...
interface ScrollIndicatorData {
  scrollPositionInVh: number
  pageHeightInViewports: number
}

export const useScrollIndicator = (): ScrollIndicatorData => {
  const [scrollData, setScrollData] = useState<ScrollIndicatorData>({
